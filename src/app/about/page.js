...
export default function About({}) {
    ...
    return (
        ...
        <Link href="/" className=" z-10 sm:hidden hover:opacity-50 text-[22px]  bg-orange-400 rotate-[354deg] h-14 w-14 flex items-center justify-center rounded-full shadow-lg absolute left-2 top-2">
        &lt; back
      </Link>
      
            <div className="flex overflow-y-scroll sm:overflow-hidden flex-col sm:flex-row w-[95%]  max-h-[85%] mt-1 sm:mt-4">
                <div className="w-full mx-2 px-8 bg-orange-100 rounded-xl shadow">
                    ...
                    <img src="/mom.png" alt="carbon" className="rounded shadow"/>
                    </div>

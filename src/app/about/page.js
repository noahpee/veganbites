...
export default function About({}) {
    ...
    return (
        ...
        <Link href="/" className=" z-10 sm:hidden  text-[22px]  bg-orange-400 rotate-[354deg] h-14 w-14 flex items-center justify-center rounded-full shadow-lg absolute left-2 top-2">
        &lt; back
      </Link>
      
            <div className="flex overflow-y-scroll sm:overflow-hidden flex-col sm:flex-row w-[95%]  max-h-[85%] mt-1 sm:mt-4">
                <div className="w-full h-[66%] mx-2 px-8 bg-orange-100 rounded shadow">
                    ...
                    <div className="flex h-[20%] w-full justify-center pt-2">
                    <img src="/carbon.webp" alt="carbon" />
                    </div>

                </div>
                <div className="w-full mx-2 sm:overflow-y-auto flex flex-col items-center">
                    <div className="h-60 w-[90%] bg-orange-200 rounded-xl shadow my-2 px-4 flex flex-col">

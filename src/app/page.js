...
export default function Home() {
  ...
  return (
    <main className="w-full h-screen overflow-y-auto z-10 flex flex-col  items-center">
      ...
      <div className="h-[85%] sm:w-[85%] w-[90%] z-10 bg-orange-200 rounded shadow flex mt-1 sm:mt-3">
          <div className="w-1/2 h-full flex flex-col items-center justify-between py-2">
      ...
      <div className="h-[75%] w-[90%] z-10 sm:w-[85%] bg-orange-200 rounded shadow flex flex-col mt-10 items-center">

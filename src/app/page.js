...
export default function Home() {
  ...
  return (
    <main className="w-full h-screen overflow-y-auto z-10 flex flex-col  items-center">
            <img src="/mom.png" alt="mom" className="absolute py-[25%] mt-6 sm:py-[7%] rounded-full  sm:flex sm:left-0 h-full opacity-20"/>
      ...
      <div className=" sm:min-h-[65%] z-10 relative w-[90%] rouned shadow sm:w-[70%] bg-orange-100 flex flex-col mt-10 items-center">
          ...
          <img className="absolute bottom-1 rotate-[6deg] h-12 right-1" src="/carbon.webp" alt="carbon" />
      ...
      <div className="h-full w-[90%] z-10 sm:w-[85%] bg-orange-200 rounded shadow flex flex-col mt-10 items-center">
        ...
        <div className="min-h-[600px] z-10 sm:w-[70%] w-[90%] bg-orange-100 rounded shadow flex flex-col mt-10 items-center">
          ...
          <form className="w-full h-[70%] flex flex-col justify-evenly items-center" onSubmit={handleSubmit}>
      ...
      <div className="max-h-[350px] z-10 min-h-[350px] w-[90%] sm:w-[70%] rounded shadow bg-orange-100 flex flex-col mt-10 items-center">
          ...
          <div className="min-h-[80%]  relative w-full flex flex-col items-center ">
          ...
          <button className="absolute left-2 hover:text-orange-700 top-[30%] text-[55px]" onClick={() => setTestyNum(prevNum => prevNum === 0 ? 4 : prevNum - 1)}>&lt;</button>
            ...
            <p className="text-[26px] text-center mt-4">{testys[testyNum].name}</p>
            <p className="text-[26px] text-center mb-1">{testys[testyNum].location}</p>
            <p className="overflow-hidden px-12 text-justify sm:text-[24px] h-full text-ellipsis overflow-y-scroll my-2"> &nbsp; &quot;{testys[testyNum].message}&quot;</p>
          </div>
      </div>

...
export default function Home() {
  ...
  return (
    <main className="w-full h-screen bg-gray-100 overflow-y-auto flex flex-col pb-2 items-center">
      <Header whatClick={whatScroll} menuClick={menuScroll} contactClick={contactScroll} galleryClick={galleryScroll} reviewClick={reviewScroll} menu={menu}/>
      
      <div onClick={() => setMenu(!menu)} className=" z-10 cursor-pointer sm:hidden  text-[45px] text-gray-800 bg-orange-400 h-14 w-14 flex items-center justify-center rounded-full shadow-lg absolute left-2 top-2">
      ☰
      </div>

      <div className="h-[85%] sm:w-[85%] w-[90%] bg-orange-200 rounded shadow flex mt-1 sm:mt-6">
          <div className="w-1/2  h-full flex flex-col items-center justify-between py-4">
            ...
            <p className="sm:text-[36px] px-2 mt-12 text-center text-[20px]">Giving you the real vegan bites</p>
      ...
      <div className=" sm:min-h-[65%]  relative w-[90%] rouned shadow sm:w-[70%] bg-orange-100 flex flex-col mt-6 items-center">
      ...
      <div className="h-[75%] w-[90%] sm:w-[85%] bg-orange-200 rounded shadow flex flex-col mt-6 items-center">
          <p className="h-[10%] text-[50px]" ref={menuRef}>Our Menu</p>
        ...
        <div className="min-h-[500px] sm:w-[70%] w-[90%] bg-orange-100 rounded shadow flex flex-col mt-4 items-center">
        ...
        <div className="h-[350px] w-[90%] sm:w-[85%] bg-orange-200 flex rounded shadow flex-col mt-6 items-center">
      ...
      <div className="max-h-[350px] min-h-[350px] w-[90%] sm:w-[70%] rounded shadow bg-orange-100 flex flex-col mt-6 items-center">
          ...
          <button className="absolute right-2 top-[30%] text-[55px]" onClick={() => setTestyNum(prevNum => prevNum === 4 ? 0 : prevNum + 1)}>&gt;</button>
          <button className="absolute left-2 top-[30%] text-[55px]" onClick={() => setTestyNum(prevNum => prevNum === 0 ? 4 : prevNum - 1)}>&lt;</button>
